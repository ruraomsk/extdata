...
При выполнении запроса SetBlinds обратите внимание, что установки конфликтов, описание направлений и настройка фаз, в настоящее время не могут записаны в контроллер. 
---
