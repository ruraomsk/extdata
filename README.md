...
## Важное замечание для GetLogers:

| Уровень |код| Прмечание| 
|-----|-------------|------------|
...
**При выполнении запроса SetBlinds обратите внимание, что установки конфликтов, описание направлений и настройка фаз,могут быть записаны в контроллер только в случае установки в true поля Full подсистемы Modbus!.** 
---
...
***Обратите внимание! Изменилась структура возврата и приема типа Setup!***
