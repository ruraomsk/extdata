...
type DefNap struct {
	...
	Keys        []bool // Ключи
	Tiob        int    // 0 выключен 1 транспортный 2 пешеходный 3 стрелка
}
...
type Line struct {
	...
	// TVP3,                           //8 вызывная фаза 3
	// TVP4,                           //9 вызывная фаза 4
	// SUB_TVP3,               //10 замещающая вызывная фаза 3
	// SUB_TVP4                //11 замещающая вызывная фаза 4
	Type  int
